...
public class NSGAIIBuilder<S extends Solution<?>> implements AlgorithmBuilder<NSGAII<S>> {
  ...
  public NSGAIIBuilder<S> setNumberOfDivisions(int numberOfDivisions){
  ...
  public DominanceComparator<S> getDominanceComparator() { return dominanceComparator; }

  public int getMatingPoolSize() { return matingPoolSize; }

  public int getOffspringPopulationSize() { return offspringPopulationSize; }
