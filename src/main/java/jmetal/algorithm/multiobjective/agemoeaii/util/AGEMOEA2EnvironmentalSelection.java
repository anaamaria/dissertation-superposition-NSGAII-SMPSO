package jmetal.algorithm.multiobjective.agemoeaii.util;

import java.util.List;
import jmetal.algorithm.multiobjective.agemoea.util.AGEMOEAEnvironmentalSelection;
...
public class AGEMOEA2EnvironmentalSelection<S extends Solution<?>> extends AGEMOEAEnvironmentalSelection<S> {
     ...
     */
    @Override
    public double computeGeometry(List<double[]> normalizedFront, List<Integer> extremePoints) {
     ...
     */
    public double[] projectPoint(double[] point, double p) {
